            ...
            <div class="col-md-8">
              ...
              <article class="blog-post">
                <p>This blog post shows a few different types of content that’s
                  ...
                  tables, images, code, and more are all supported as
                  expected.</p>
                <hr>
                <p>This is some additional paragraph placeholder content. It has
                ...
                <p>HTML defines a long list of available inline tags, a complete
                  list of which can be found on the <a
                ...
                <ul>
                  ...
                  <li>Abbreviations, like <abbr
                      title="HyperText Markup Language">HTML</abbr> should use
                    <code
                    ...
                    <li>
                      <a
                        ...
                        <svg class="bd-placeholder-img" width="100%" height="96"
                          ...
                          focusable="false"><rect width="100%" height="100%"
                            fill="#777"></rect></svg>
                        <div class="col-lg-8">
                          <h6 class="mb-0">Example blog post title</h6>
                          <small class="text-body-secondary">January 15,
                            2024</small>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a
                        ...
                        <div class="col-lg-8">
                          ...
                          <small class="text-body-secondary">January 14,
                            2024</small>
                        </div>
                      </a>
                    </li>
                      ...
                      <a
                        ...
                        <div class="col-lg-8">
                          <h6 class="mb-0">Longer blog post title: This one has
                            multiple lines!</h6>
                          <small class="text-body-secondary">January 13,
                            2024</small>
                        </div>
                      </a>
                    </li>
